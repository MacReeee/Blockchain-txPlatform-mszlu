...
func file_register_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_register_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*RegRes); i {
			case 0:
				return &v.state
			case 1:
		...
		file_register_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*NoRes); i {
			case 0:
				return &v.state
			case 1:
		...
		file_register_proto_msgTypes[4].Exporter = func(v any, i int) any {
